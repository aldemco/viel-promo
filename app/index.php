    ...
    <div class="container">
        <div class="site-header">
            ...
            <div class="header-actions">
                ...
                <a href="#callback" class="popup_btn header-actions__btn btn btn_success btn_small">
                    Обратный звонок
                </a>
            </div>
     </div>
...
<main>
    ...
    <section class="promo-section" id="promo">
        <div class="container">
            ...
            <div class="promo-section__actions">
                <a href="#get-promo" class="promo-section__btn btn btn_warning btn_medium popup_btn">
                    Купить по акции
                </a>
            </div>
    ...
    <section class="health-section">
        <div class="container health-section__container">
            <div class="health-section__left-col">
                ...
                <a href="#get-price" class="popup_btn popup_btn health-section__btn btn btn_success btn_large" data-popup-from="Оздоровительные процедуры">
                    Узнать стоимость
                </a>
            </div>
    ...
    <section class="children-section" id="services">
        <div class="container children-section__container">
            ...
            <div class="children-section__right-col">
                ...
                <a href="#get-price" class="popup_btn children-section__btn btn btn_warning btn_large" data-popup-from="Детям">
                    Узнать стоимость
                </a>
            </div>
        </div>
    ...
    <section class="reability-section">
        <div class="container reability-section__container">
            <div class="reability-section__left-col">
                ...
                <a href="#get-price" class="popup_btn reability-section__btn btn btn_success btn_large" data-popup-from="Реабилитология">
                    Узнать стоимость
                </a>
            </div>
    ...
    <section class="body-section">
        <div class="container body-section__container">
            ...
            <div class="body-section__right-col">
                ...
                <a href="#get-price" class="popup_btn body-section__btn btn btn_warning btn_large" data-popup-from="Коррекция фигуры">
                    Узнать стоимость
                </a>
            </div>
        </div>
    ...
    <section class="spa-section">
        <div class="container spa-section__container">
            <div class="spa-section__left-col">
                ...
                <a href="#get-price" class="popup_btn spa-section__btn btn btn_warning btn_large" data-popup-from="Spa-процедуры">
                    Узнать стоимость
                </a>
            </div>
    ...
    <section class="face-section">
        <div class="container face-section__container">
            ...
            <div class="face-section__right-col">
                ...
                <a href="#get-price" class="popup_btn face-section__btn btn btn_warning btn_large" data-popup-from="Spa-процедуры">
                    Узнать стоимость
                </a>
            </div>
        </div>
            ...
            <div class="employee-section__list">
                <div class="employer">
                    ...
                    <div class="employer__actions">
                        <a href="#empl1" class="popup_btn employer__btn btn btn_line btn_success btn_small" data-popup-from="Бычик Виолетта 
                        Вячеславовна">
                            Подробнее
                        </a>
                        <a href="#empl1" class="popup_btn employer__btn btn btn_warning btn_small" data-popup-from="Бычик Виолетта 
                        Вячеславовна">
                            Записаться на прием
                        </a>
                    </div>
                ...
                <div class="employer">
                    ...
                    <div class="employer__actions">
                        <a href="#empl2" class="popup_btn employer__btn btn btn_line btn_success btn_small" data-popup-from="Дроздов 
                        Игорь Юрьевич">
                            Подробнее
                        </a>
                        <a href="#empl2" class="popup_btn employer__btn btn btn_warning btn_small" data-popup-from="Дроздов 
                        Игорь Юрьевич">
                            Записаться на прием
                        </a>
                    </div>
                ...
                <div class="employer">
                    ...
                    <div class="employer__actions">
                        <a href="#empl3" class="popup_btn employer__btn btn btn_line btn_success btn_small" data-popup-from="Бычик Эльвира
                        Игоревна">
                            Подробнее
                        </a>
                        <a href="#empl3" class="popup_btn employer__btn btn btn_warning btn_small" data-popup-from="Бычик Эльвира
                        Игоревна">
                            Записаться на прием
                        </a>
                    </div>
                ...
                <div class="swiper-wrapper testimonials-slider__wrapper">
                     <div class="swiper-slide">
                        <div class="testimonials-slider__slide">
                            ...
                            <span class="testimonials-slider__name">Мирошниченко Екатерина</span>
                            <p class="testimonials-slider__comment">
                                Много лет мучалась частыми головными болями, головокружениями, усталостью и тяжестью в шейном отлеле, поясничными болями. Сидячая работа, малоподвижный образ жизни и прочие атрибуты современной жизни активно способствовали всему этому. Спустя годы походов по больницам, и посещением огромного количества врачей, горстями употребляя таблетки, в отчаявшемся состоянии  попала в "Золотые руки" Виолетты Вячеславовны. Это магия, чудо, по-другому и не описать, и как говорят все «как рукой сняло»! Эффект от лечения наступает довольно быстро. Если не запустить болезнь, регулярно выделять время для посещения врача-остеопата, то всегда будешь чувствовать себя в хорошей форме, бодро и уверенно. Теперь, если у меня какие-то проблемы,то я всегда знаю куда идти! 
                                Виолетта Вячеславовна настоящий знаток своего дела. Очень мягко, внимательно проводит прием, без всякой суеты, лишних движений. К тому же  она приветливый, внимательный, отзывчивый человек, к которому приятно приходить. Огромное спасибо за лечение и чуткое отношение. Желаю успехов и процветания.
                            </p>
                        </div>
                    </div>
                    <div class="swiper-slide">
                    ...
                    <div class="swiper-slide">
                        <div class="testimonials-slider__slide">
                            ...
                            <p class="testimonials-slider__comment">
                                Здравствуйте, хочу рассказать свою историю, как я попала в центр Виэль к Виолетте Вячеславовне Бычик. Полтора года я ходила по неврологам с букетом заболеваний: вертепрогенная цервиколгия, всд, протрузии, грыжи, постоянная жуткая головная боль, звоны в голове до тошноты, люмбаго, опущение правого плеча, каждый месяц уколы и постоянно таблетки, а результатов никаких, состояние не улучшалось. И вот выходя из поликлиники с очередным рецептом и слезами на глазах, увидела вывеску Виэль, записалась на прием к остеопату.когда шла на приём-консультацию, думала скажут вам не к нам. А Виолетта Вячеславовна посмотрела меня, посмотрела мои медицинские бумаги и предложила методику лечения: массаж и остеопатия. Вот прошло три месяца(из-за пандемии и режима самоизоляции был конечно перерыв в лечении), но за это время я не уколола ни одного укола, не пила серьёзных препаратов. Моё состояние уже улучшилось на 70%, я хожу, я работаю! Лечение продолжаю. От всей души выражаю благодарность Виолетте Вячеславовне, её чудо рукам, врач с большой буквы, внимательный и чуткий человек, вернула меня к полноценной жизни. Обязательно рекомендую центр Виэль, здесь найдёте здоровье!!!
                            </p>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="testimonials-slider__slide">
                            ...
                            <p class="testimonials-slider__comment">
                                Хожу в центр с большим удовольствием! Все специалисты очень любезны и общительны, на входе всегда встречает меня улыбчивый администратор. Обратился за помощью, болит спина. Мне тут же предложили БЕСПЛАТНУЮ консультацию, и сразу же осмотрел специалист. Записался на массаж, отходил весь курс, остался очень довольным, а самое интересное мне реально помогли решить мою многолетнюю проблему!!!
                            </p>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="testimonials-slider__slide">
                            ...
                            <p class="testimonials-slider__comment">
                                Приветствую всех!  Мед.центр Виэль мне понравился не только своим радушным приемом, я получил максимум удовольствия от лечебноголмассажа. Боли в спине исчезли. Благодарен Виолетте Вячеславовне за ее внимание и за достижение результата! Очень советую обратиться именно к ней. Это специалист золотые руки! Эффективный массаж для меня очень важен.
                            </p>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="testimonials-slider__slide">
                            ...
                            <p class="testimonials-slider__comment">
                                Очень довольна и впечатлена результатами от сеансов и работы Виолетты. Низкий Вам поклон и безграничная благодарность. И огромная благодарность всему персоналу Центра за доброжелательность и отзывчивость
                            </p>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="testimonials-slider__slide">
                            ...
                            <p class="testimonials-slider__comment">
                                Записала жена на пиявки)) сам в них никогда не верил, оказалось зря. Замечательное обслуживание и высокий профессионализм. Проблем со здоровьем больше нет, готов советовать Виэль всем друзьям и знакомым! 
                            </p>
                        </div>
                    </div>
                </div>
    ...
    <section class="question-section">
        <div class="container question-section__container">
            ...
            <div class="question-section__right-col">
                ...
                <a href="#callback" class="popup_btn question-section__btn btn btn_light btn_large" data-popup-from="Вопрос руководителю">
    ...
    <section class="contacts-section" id="contacts">
        <div class="contacts-section__map">
            <script type="text/javascript" charset="utf-8" async src="https://api-maps.yandex.ru/services/constructor/1.0/js/?um=constructor%3A9db132641effa614181e32aeb5cb61712ab4a42f4e8cb7ef92613b2f0d403973&amp;width=100%25&amp;height=640&amp;lang=ru_RU&amp;scroll=true"></script>
        </div>
...
<div class="popup" id="get-price">
    ...
    <div class="popup__body">
        ...
        <p class="popup__message">Оставьте заявку и получите полный прайс 
            на услуги Центра массажа и остеопрактики "Виэль”
        </p>
...
<div class="popup" id="callback">
    ...
    <div class="popup__body">
        ...
        <p class="popup__message">Оставьте Ваши контакты и наш специалист  свяжется с Вами в самое ближайшее время
        </p>
...
<div class="popup" id="get-promo">
    ...
    <div class="popup__body">
        ...
        <p class="popup__message">Участвуйте в акциях Центра массажа и остеопрактики "Виэль", получите скидку прямо сейчас
        </p>
        <form action="/" method="POST" class="popup__form" id="promo-form" data-goal="skidka">
            <div class="popup__form-row">
